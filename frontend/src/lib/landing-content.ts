...
export const PROBLEMS = [
  {
    title: "Retrabalho",
    description: "Tarefas repetidas que consomem tempo e aumentam erros.",
    icon: "retrabalho",
  },
  {
    title: "Planilhas",
    description: "Dados espalhados em planilhas difíceis de manter e auditar.",
    icon: "planilhas",
  },
  {
    title: "Processos manuais",
    description: "Fluxos dependentes de pessoas em cada etapa do dia a dia.",
    icon: "processos",
  },
  {
    title: "Desorganização",
    description: "Falta de visão única sobre demandas, prazos e prioridades.",
    icon: "desorganizacao",
  },
  {
    title: "Gargalos",
    description: "Pontos críticos que travam a operação e a entrega.",
    icon: "gargalos",
  },
] as const;

export const SOLUTIONS = [
  { title: "Dashboards", description: "Indicadores e visão gerencial em tempo real." },
  { title: "Automação", description: "Rotinas repetitivas executadas com menos esforço." },
  { title: "Apps internos", description: "Ferramentas sob medida para o seu processo." },
  { title: "IA aplicada", description: "Inteligência artificial em problemas concretos." },
  { title: "Digitalização", description: "Papel e planilhas viram fluxos digitais." },
  { title: "Organização", description: "Estrutura clara de dados, etapas e responsáveis." },
] as const;

export const FLOW_STEPS = [
  {
    step: "1",
    title: "Empresa envia o desafio",
    description: "Você descreve o problema real e o contexto operacional.",
  },
  {
    step: "2",
    title: "Equipe analisa e qualifica",
    description: "Triagem técnica e alinhamento de viabilidade com o programa.",
  },
  {
    step: "3",
  ...
  {
    step: "4",
    title: "Solução é desenvolvida",
    description: "Talentos em TIC constroem a solução com mentoria e supervisão.",
  },
] as const;
